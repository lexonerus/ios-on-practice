...
#ifndef URLSESSIONEXAMPLE_SWIFT_H
#define URLSESSIONEXAMPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="URLSessionExample",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17URLSessionExample11AppDelegate")
...
SWIFT_CLASS("_TtC17URLSessionExample13SceneDelegate")
...
SWIFT_CLASS("_TtC17URLSessionExample14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified imageView;
- (IBAction)getImageButtonPressed:(id _Nonnull)sender;
- (void)viewDidLoad;
